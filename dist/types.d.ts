export type SDKEventType = 'ready' | 'onboarding_start' | 'onboarding_complete' | 'onboarding_exit' | 'screen_view' | 'screen_leave' | 'navigation_back' | 'button_click' | 'choice_select' | 'choice_deselect';
...
export type SDKEvent = ReadyEvent | OnboardingStartEvent | OnboardingCompleteEvent | OnboardingExitEvent | ScreenViewEvent | ScreenLeaveEvent | NavigationBackEvent | ButtonClickEvent | ChoiceSelectEvent | ChoiceDeselectEvent;
